...
function showDiv(language) {
    ...
    if (language == "html") {
        quizDiv.innerHTML = `
        <div class="html-quiz-main-div">
            <div class="question-body">
                <div class="question-div">
                    <span id="question">Q. ${html.question1.question}</span>
                    <button type="button" class="btn-close" onclick="closeDiv()"></button>
                </div>
                <div class="options-div">
                    <div d="queOption1">
                        <input type="radio" name="name" id="" value="q1">
                        <span i>${html.question1.option1}</span>
                    </div>
                    <div id="queOption2">
                        <input type="radio" name="name" id="" value="q1">
                        <span >${html.question1.option2}</span>
                    </div>
                    <div id="queOption3">
                        <input type="radio" name="name" id="" value="q1">
                        <span >${html.question1.option3}</span>
                    </div>
                    <div id="queOption4">
                    </div>
                </div>
    ...
    `
        ...
        <div class="html-quiz-main-div">
            <div class="question-body">
                <div class="question-div">
                    <span id="question">Q. ${css.question1.question}</span>
                    <button type="button" class="btn-close" onclick="closeDiv()"></button>
                </div>
                <div class="options-div">
                    <div id="queOption1">
                        <input type="radio" name="name" id="" value="q1">
                        <span>${css.question2.option1}</span>
                    </div>
                    <div id="queOption2">
                        <input type="radio" name="name" id="" value="q1">
                        <span>${css.question2.option2}</span>
                    </div>
                    <div id="queOption3">
                        <input type="radio" name="name" id="" value="q1">
                        <span>${css.question2.option3}</span>
                    </div>
                    <div id="queOption4">
                        <input type="radio" name="name" id="" value="q1">
                        <span>${css.question1.option4}</span>
                    </div>
                </div>
            </div>
            <div class="next-question">
    ...
    `
        ...
        <div class="html-quiz-main-div">
            <div class="question-body">
                <div class="question-div">
                    <span id="question">Q. ${js.question1.question}</span>
                    <button type="button" class="btn-close" onclick="closeDiv()"></button>
                </div>
                <div class="options-div">
                    <div id="queOption1">
                        <input type="radio" name="name" id="" value="q1">
                        <span>${js.question1.option1}</span>
                    </div>
                    <div id="queOption2">
                        <input type="radio" name="name" id="" value="q1">
                        <span>${js.question1.option2}</span>
                    </div>
                    <div id="queOption3">
                        <input type="radio" name="name" id="" value="q1">
                        <span>${js.question1.option3}</span>
                    </div>
                    <div id="queOption4">
                    <input type="radio" name="name" id="" value="q1">
                    <span>${js.question1.option4}</span>
                    </div>
                </div>
            </div>
            <div class="next-question">
